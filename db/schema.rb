...
ActiveRecord::Schema[7.1].define(version: 2026_04_10_000002) do
  ...
  create_table "contacts", id: :serial, force: :cascade do |t|
    ...
    t.index ["pipeline_stage_id"], name: "index_contacts_on_pipeline_stage_id"
  end
  ...
  add_foreign_key "contacts", "pipeline_stages"
